...
const UpdateUser=()=>{
    ...
    function saveData(data){
        axios.put(`http://localhost:8001/emp/${studentID}`,data)
    ...
    return(
      ...
      <form onSubmit={handleSubmit(saveData)}>
        ...
        <button type='reset' className='btn btn-outline-warning col-3 offset-2' >CLEAR FIELD</button>
      </form>
